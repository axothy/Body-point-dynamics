...
import static ru.axothy.mechanics.equationsolvers.RuthMethodForSystem.Coefficients.*;


public class RuthMethodForSystem {

    class Coefficients {
        public static final double C1 = 1;
        public static final double C2 = -2.0 / 3.0;
        public static final double C3 = 2.0 / 3.0;
        public static final double D1 = -1.0 / 24.0;
        public static final double D2 = 3.0 / 4.0;
        public static final double D3 = 7.0 / 24.0;
    }
    ...
    public static void main(String[] args) {
        ...
        RuthMethodForSystem solver = new RuthMethodForSystem();
